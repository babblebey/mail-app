...
- **Folder-aware batch actions**: Batch action buttons are context-aware based on the current folder. "Report Spam" is hidden in Drafts and Trash folders since it is not meaningful there. Inbox and Sent show the full default set of actions. Trash omits "Report Spam" and will gain a "Delete Forever" action in a future PRD.
